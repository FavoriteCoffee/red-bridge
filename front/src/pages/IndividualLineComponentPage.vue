    ...
    <v-row>
        <div class="content">
            <div class="main-content">
                ...
                <h4 class="lines-title">Супер-пупер деталька 3000Х PRO MAX</h4>
                <div class="hr"></div>
                ...
                <details>
                    <summary><h4>&#X203A; Состав детальки</h4></summary>
                    <p>Раскрывающийся контент</p>
                </details>
                <details>
                    <summary><h4>&#X203A; Требования для установки</h4></summary>
                    <p>Раскрывающийся контент</p>
                </details>
                <details>
                    <summary><h4>&#X203A; Установка и ввод в эксплуатацию</h4></summary>
                    <p>Раскрывающийся контент</p>
                </details>
                <details>
                    <summary><h4>&#X203A; Характеристики детальки</h4></summary>
                    <p>Раскрывающийся контент</p>
                </details>
                <details>
